...
export const programCovers: Record<string, any> = {
  ...
  // === Added from CSV (2026 Pathways) ===
  'ul-mp': require('../../assets/covers/ul-mp.jpg'),
  'rtha': require('../../assets/covers/rtha.jpg'),
  'ml': require('../../assets/covers/ml.jpg'),
  'mgm': require('../../assets/covers/mgm.jpg'),
  'npow': require('../../assets/covers/npow.jpg'),
  'man': require('../../assets/covers/man.jpg'),
  'bfi': require('../../assets/covers/bfi.jpg'),
  'tpob': require('../../assets/covers/tpob.jpg'),
  'lea': require('../../assets/covers/lea.jpg'),
  'tl': require('../../assets/covers/tl.jpg'),
  'smfs': require('../../assets/covers/smfs.jpg'),
  'awa': require('../../assets/covers/awa.jpg'),
  'hof': require('../../assets/covers/hof.jpg'),
  'tqpm': require('../../assets/covers/tqpm.jpg'),
  'lbyor': require('../../assets/covers/lbyor.jpg'),
  '3miq': require('../../assets/covers/3miq.jpg'),
  'eb': require('../../assets/covers/eb.jpg'),
  'css': require('../../assets/covers/css.jpg'),
  'hbo': require('../../assets/covers/hbo.jpg'),
  'bfb': require('../../assets/covers/bfb.jpg'),
  'z100': require('../../assets/covers/z100.jpg'),
  'syb': require('../../assets/covers/syb.jpg'),
  '5dpm': require('../../assets/covers/5dpm.jpg'),
  'sr': require('../../assets/covers/sr.jpg'),
  'vv': require('../../assets/covers/vv.jpg'),
  'myq': require('../../assets/covers/myq.jpg'),
  'mqg': require('../../assets/covers/mqg.jpg'),
  'bf-rd': require('../../assets/covers/bf-rd.jpg'),
  'tmos': require('../../assets/covers/tmos.jpg'),
  '7dbs': require('../../assets/covers/7dbs.jpg'),
  'ahw': require('../../assets/covers/ahw.jpg'),
  'twkb': require('../../assets/covers/twkb.jpg'),
  'ttt': require('../../assets/covers/ttt.jpg'),
  'bf-ld': require('../../assets/covers/bf-ld.jpg'),
  'tmw': require('../../assets/covers/tmw.jpg'),
  'tib': require('../../assets/covers/tib.jpg'),
  'snh': require('../../assets/covers/snh.jpg'),
  'guth': require('../../assets/covers/guth.jpg'),
  'tugs': require('../../assets/covers/tugs.jpg'),
  'tt': require('../../assets/covers/tt.jpg'),
  'wws': require('../../assets/covers/wws.jpg'),
  'sgs': require('../../assets/covers/sgs.jpg'),
  'wp': require('../../assets/covers/wp.jpg'),
  'cito': require('../../assets/covers/cito.jpg'),
  'mc': require('../../assets/covers/mc.jpg'),
  'bl': require('../../assets/covers/bl.jpg'),
  'ql': require('../../assets/covers/ql.jpg'),
  'cu': require('../../assets/covers/cu.jpg'),
  'hfh': require('../../assets/covers/hfh.jpg'),
  'zvkg': require('../../assets/covers/zvkg.jpg'),
  'zvkp': require('../../assets/covers/zvkp.jpg'),
  'cfdc': require('../../assets/covers/cfdc.jpg'),
  'eol': require('../../assets/covers/eol.jpg'),
  'bis': require('../../assets/covers/bis.jpg'),
  'net': require('../../assets/covers/net.jpg'),
  'pp': require('../../assets/covers/pp.jpg'),
  'tse': require('../../assets/covers/tse.jpg'),
  '7fc': require('../../assets/covers/7fc.jpg'),
  'bcmd': require('../../assets/covers/bcmd.jpg'),
  'ew': require('../../assets/covers/ew.jpg'),
  'tscd': require('../../assets/covers/tscd.jpg'),
  'tqe': require('../../assets/covers/tqe.jpg'),
  'ush': require('../../assets/covers/ush.jpg'),
  'faf': require('../../assets/covers/faf.jpg'),
  'bydc': require('../../assets/covers/bydc.jpg'),
  'tcm': require('../../assets/covers/tcm.jpg'),
  'sp': require('../../assets/covers/sp.jpg'),
  'spb': require('../../assets/covers/spb.jpg'),
...
// Meditation covers
// All meditation covers were renamed to lowercase slug filenames (2026-05-26)
// to match the broader 993-cover bundle pulled from the Audiowaves CSV.
// See src/data/meditationCoverUrls.ts for the full name-keyed map.
...
// Helper to get meditation cover. Accepts either:
//   - a legacy path string (e.g. "/meditation-covers/Profound_Sleep.jpg") — the
//     pattern used in src/data/meditationLibrary.ts, or
//   - a meditation title (e.g. "Abundance Meditation") — used by newer surfaces
//     that drive lookups by name from the full CSV-backed library.
export function getMeditationCover(imagePathOrName: string): any {
  return (
    meditationCoversByPath[imagePathOrName]
    ?? meditationCoverUrls[imagePathOrName]
    ?? null
  );
}
